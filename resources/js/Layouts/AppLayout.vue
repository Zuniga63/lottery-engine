    ...
    <div class="min-h-screen bg-gray-100">
      <nav class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <!-- Navigation Links -->
              <div v-for="(link, index) in links" :key="index" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <jet-nav-link
        ...
        <div
          ...
          class="sm:hidden"
        >
          <div class="pt-2 pb-3 space-y-1" v-for="(link, index) in links" :key="index">
